    ...
    <div class="series-hero">
        ...
        <div class="hero-content">
            ...
            <p class="hero-description">
                SwiftUI를 활용한 프로젝트 관련 공부들과, 협업 관련해서 발생하는 궁금점들에 대한 DeepDive를 담았습니다 !
            </p>
            {% assign swiftui_posts = site.posts | where_exp: 'post', 'post.categories contains "SwiftUI"' %}
            <div class="hero-stats">
                <span class="stat">📝 {{ swiftui_posts.size }}개 포스트</span>
                {% if swiftui_posts.size > 0 %}
                <span class="stat">📅 {{ swiftui_posts.last.date | date: "%Y.%m" }} - {{ swiftui_posts.first.date | date: "%Y.%m" }}</span>
                {% endif %}
            </div>
        </div>
    </div>
...
<div class="series-detail-content">
    ...
    <div class="featured-post">
        {% assign latest_post = swiftui_posts.first %}
    ...
    <div class="posts-timeline">
        ...
        {% assign posts_by_year = swiftui_posts | group_by_exp: 'post', 'post.date | date: "%Y"' %}
    ...
    <div class="no-posts">
        ...
        <h3>SwiftUI 포스트를 준비 중입니다</h3>
        <p>곧 SwiftUI 개발 경험과 팁을 공유할 예정이에요!</p>
    </div>
    {% endif %}
</div>
