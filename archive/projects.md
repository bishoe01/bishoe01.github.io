...
layout: page
title: "프로젝트 🚀"
description: "개인 및 팀 프로젝트 개발 과정과 회고를 모아봤습니다"
    ...
    <div class="series-hero">
        ...
        <div class="hero-content">
            ...
            <p class="hero-description">
                개인 및 팀 프로젝트의 기획부터 개발, 배포까지의 전 과정과 
                프로젝트를 통해 얻은 인사이트를 기록한 시리즈입니다.
            </p>
            {% assign project_posts = site.posts | where_exp: 'post', 'post.categories contains "프로젝트"' %}
            <div class="hero-stats">
                <span class="stat">📝 {{ project_posts.size }}개 포스트</span>
                {% if project_posts.size > 0 %}
                <span class="stat">📅 {{ project_posts.last.date | date: "%Y.%m" }} - {{ project_posts.first.date | date: "%Y.%m" }}</span>
                {% endif %}
            </div>
        </div>
    </div>
...
<div class="series-detail-content">
    ...
    <div class="featured-post">
        {% assign latest_post = project_posts.first %}
    ...
    <div class="posts-timeline">
        ...
        {% assign posts_by_year = project_posts | group_by_exp: 'post', 'post.date | date: "%Y"' %}
        ...
        <div class="timeline-year">
            ...
            <div class="timeline-posts">
                ...
                <article class="timeline-post">
                    <div class="post-date-badge project-badge">
    ...
    <div class="no-posts">
        ...
        <h3>프로젝트 포스트를 준비 중입니다</h3>
        <p>곧 다양한 프로젝트 경험을 공유할 예정이에요!</p>
    </div>
    {% endif %}
</div>
